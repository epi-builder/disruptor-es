...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 01-01-01 | 01 | 1 | CORE-01, CORE-04 | T-01-01 / T-01-02 | Workspace pins Rust 2024 and forbids unsafe code without runtime/storage dependencies | config | `rustc +1.85 --version && cargo +1.85 --version && grep -E 'resolver = "3"\|edition = "2024"\|rust-version = "1.85"\|unsafe_code = "forbid"' Cargo.toml` | W1 | pending |
...
- [x] `01-04-PLAN.md` creates `tests/dependency_boundaries.rs` before the full phase gate.
